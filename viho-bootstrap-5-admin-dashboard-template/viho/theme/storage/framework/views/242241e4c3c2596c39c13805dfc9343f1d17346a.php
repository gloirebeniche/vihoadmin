	                        ...
	                        <div class="blog-box blog-list row">
	                            <div class="col-xl-6 col-12">
	                                <div class="blog-wrraper">
	                                    <a href="blog-single.html"><img class="img-fluid sm-100-wp p-0" src="<?php echo e(asset('assets/images/blog/blog-2.jpg')); ?>" alt="" /></a>
	                                </div>
	                            </div>
	                            <div class="col-xl-6 col-12">
	                                <div class="blog-details">
	                ...
	                <div class="col-xl-12 col-md-6">
	                    <div class="card">
	                        <div class="blog-box blog-list row">
	                            <div class="col-xl-6 col-12">
	                                <div class="blog-wrraper">
	                                    <a href="blog-single.html"><img class="img-fluid sm-100-w p-0" src="<?php echo e(asset('assets/images/blog/blog-3.jpg')); ?>" alt="" /></a>
	                                </div>
	                            </div>
	                            <div class="col-xl-6 col-12">
	                                <div class="blog-details">
	        ...
	        <div class="col-sm-6 col-xl-3 box-col-6 des-xl-50">
	            <div class="card">
	                <div class="blog-box blog-grid">
	                    <div class="blog-wrraper">
	                        <a href="blog-single.html"><img class="img-fluid top-radius-blog" src="<?php echo e(asset('assets/images/blog/blog-5.jpg')); ?>" alt="" /></a>
	                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Viho-Laravel-8/theme/resources/views/admin/miscellaneous/blog.blade.php ENDPATH**/ ?>