<?php $__env->startSection('title'); ?>Email Read
	                                        ...
	                                        <div class="email-wrapper">
	                                            ...
	                                            <div class="emailread-group">
	                                                ...
	                                                <div class="attachment">
	                                                    <ul>
	                                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/email/1.jpg')); ?>" alt="" /></li>
	                                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/email/2.jpg')); ?>" alt="" /></li>
	                                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/email/3.jpg')); ?>" alt="" /></li>
	                                                    </ul>
	                                                </div>
	                                            </div>
	                                            <div class="emailread-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Viho-Laravel-8/theme/resources/views/admin/apps/email_read.blade.php ENDPATH**/ ?>