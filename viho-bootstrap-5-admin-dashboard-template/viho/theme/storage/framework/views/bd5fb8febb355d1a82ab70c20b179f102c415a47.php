<?php $__env->startSection('title'); ?>Social App
 <?php echo e($title); ?>
	        ...
	        <div class="row">
	            <div class="col-sm-12">
	                <div class="card profile-header">
	                    <img class="img-fluid bg-img-cover" src="<?php echo e(asset('assets/images/user-profile/bg-profile.jpg')); ?>" alt="" />
	                    <div class="profile-img-wrrap"><img class="img-fluid bg-img-cover" src="<?php echo e(asset('assets/images/user-profile/bg-profile.jpg')); ?>" alt="" /></div>
	                    <div class="userpro-box">
	                        <div class="img-wrraper">
	                            <div class="avatar"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/user/7.jpg')); ?>" /></div>
	                    ...
	                    <div class="col-xl-3 xl-40 col-md-5 box-col-4">
	                        <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc4">
	                            <div class="row">
	                                    ...
	                                    <div class="card">
	                                        ...
	                                        <div class="collapse show" id="collapseicon" aria-labelledby="collapseicon" data-parent="#accordion">
	                                            <div class="card-body socialprofile filter-cards-view">
	                                                <div class="media">
	                                                    <img class="img-50 img-fluid m-r-20 rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />
	                                                    ...
	                                                    <ul>
	                                                        <li class="d-inline-block">
	                                                            <img
	                                                                ...
	                                                                src="<?php echo e(asset('assets/images/user/3.jpg')); ?>"
	                                                                alt=""
	                                                                data-container="body"
	                                                        ...
	                                                        <li class="d-inline-block">
	                                                            <img
	                                                                class="img-30 rounded-circle"
	                                                                src="<?php echo e(asset('assets/images/user/5.jpg')); ?>"
	                                                                alt=""
	                                                                data-container="body"
	                                                                data-bs-toggle="popover"
	                                                                data-placement="top"
	                                                        ...
	                                                        <li class="d-inline-block">
	                                                            <img
	                                                                class="img-30 rounded-circle"
	                                                                src="<?php echo e(asset('assets/images/user/1.jpg')); ?>"
	                                                                alt=""
	                                                                data-container="body"
	                                                                data-bs-toggle="popover"
	                                                                data-placement="top"
	                                                        ...
	                                                        <li class="d-inline-block">
	                                                            <img
	                                                                class="img-30 rounded-circle"
	                                                                src="<?php echo e(asset('assets/images/user/2.png')); ?>"
	                                                                alt=""
	                                                                data-container="body"
	                                                                data-bs-toggle="popover"
	                                                                data-placement="top"
	                                                        ...
	                                                        <li class="d-inline-block">
	                                                            <img
	                                                                class="img-30 rounded-circle"
	                                                                src="<?php echo e(asset('assets/images/user/8.jpg')); ?>"
	                                                                alt=""
	                                                                data-container="body"
	                                                                data-bs-toggle="popover"
	                                                                data-placement="top"
	                                                        ...
	                                                        <li class="d-inline-block">
	                                                            <img
	                                                                class="img-30 rounded-circle"
	                                                                src="<?php echo e(asset('assets/images/user/11.png')); ?>"
	                                                                alt=""
	                                                                data-container="body"
	                                                                data-bs-toggle="popover"
	                                                                data-placement="top"
	                                ...
	                                <div class="col-xl-12">
	                                    <div class="card"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/timeline-3.png')); ?>" /></div>
	                                </div>
	                                    ...
	                                    <div class="card">
	                                        ...
	                                        <div class="collapse show" id="collapseicon1" data-parent="#accordion" aria-labelledby="collapseicon1">
	                                            <div class="card-body social-status filter-cards-view">
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/2.png')); ?>" alt="" />
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/10.jpg')); ?>" alt="" />
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/6.jpg')); ?>" alt="" />
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/8.jpg')); ?>" alt="" />
	                                                    <div class="social-status social-offline"></div>
	                                                    <div class="media-body">
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/14.png')); ?>" alt="" />
	                                                    <div class="social-status social-online"></div>
	                                                    <div class="media-body">
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/4.jpg')); ?>" alt="" />
	                                                    <div class="social-status social-busy"></div>
	                                                    <div class="media-body"><span class="f-w-600 d-block">Johny Waston</span><span class="d-block">johny@gmail.com</span></div>
	                                                </div>
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/3.png')); ?>" alt="" />
	                                                    <div class="social-status social-offline"></div>
	                                                    <div class="media-body">
	                                    ...
	                                    <div class="card">
	                                        ...
	                                        <div class="collapse show" id="collapseicon12" aria-labelledby="collapseicon12" data-parent="#accordion">
	                                            <div class="card-body social-status filter-cards-view">
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" alt="" />
	                                                    <div class="media-body">
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 rounded-circle m-r-15" src="<?php echo e(asset('assets/images/user/5.jpg')); ?>" alt="" />
	                                                    <div class="media-body">
	                                ...
	                                <div class="card">
	                                    <div class="card-body">
	                                        <div class="new-users-social">
	                                            <div class="media">
	                                                <img class="rounded-circle image-radius m-r-15" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />
	                                                <div class="media-body">
	                                        ...
	                                        <img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/timeline-1.png')); ?>" />
	                                        <div class="timeline-content">
	                                            ...
	                                            <div class="social-chat">
	                                                <div class="your-msg">
	                                                    <div class="media">
	                                                        <img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" />
	                                                        <div class="media-body">
	                                                            <span class="f-w-600">
	                                                ...
	                                                <div class="other-msg">
	                                                    <div class="media">
	                                                        <img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/2.png')); ?>" />
	                                                        <div class="media-body">
	                                                            <span class="f-w-600">
	                                                ...
	                                                <div class="other-msg">
	                                                    <div class="media">
	                                                        <img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/3.png')); ?>" />
	                                                        <div class="media-body">
	                                                            <span class="f-w-600">
	                                                ...
	                                                <div class="media">
	                                                    ...
	                                                    <div class="media-body">
	                                                        <div class="input-group text-box">
	                                                            ...
	                                                            <div class="input-group-text"><img src="<?php echo e(asset('assets/images/smiley.png')); ?>" alt="" /></div>
	                                                        </div>
	                                                    </div>
	                                                </div>
	                                            </div>
	                            ...
	                            <div class="col-sm-12">
	                                <div class="card">
	                                    <div class="card-body">
	                                        ...
	                                        <img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/timeline-2.png')); ?>" />
	                                        <div class="timeline-content">
	                                            <p>
	                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse sed urna in justo euismod condimentum. Fusce placerat enim et odio molestie sagittis.
	                                            </p>
	                                    ...
	                                    <div class="card">
	                                        ...
	                                        <div class="collapse show" id="collapseicon3" aria-labelledby="collapseicon3" data-parent="#accordion">
	                                            <div class="card-body social-list filter-cards-view">
	                                                ...
	                                                <div class="media">
	                                                    <img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" />
	                                                    <div class="media-body">
	                                                        <a href=#><span class="d-block">Jason Borne</span></a><a href="javascript:void(0)">Add Friend</a>
	                                                    </div>
	                                                </div>
	                                                <div class="media">
	                                                    <img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/10.jpg')); ?>" />
	                                                    <div class="media-body">
	                                                        <a href=#><span class="d-block">Comeren Diaz</span></a><a href="javascript:void(0)">Add Friend</a>
	                                                    </div>
	                                                </div>
	                                                <div class="media">
	                                                    <img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/11.png')); ?>" />
	                                                    <div class="media-body">
	                                    ...
	                                    <div class="card">
	                                        ...
	                                        <div class="collapse show" id="collapseicon4" data-parent="#accordion" aria-labelledby="collapseicon4">
	                                            <div class="card-body photos filter-cards-view">
	                                                <ul>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-1.png')); ?>" /></div>
	                                                    </li>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-2.png')); ?>" /></div>
	                                                    </li>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-3.png')); ?>" /></div>
	                                                    </li>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-4.png')); ?>" /></div>
	                                                    </li>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-5.png')); ?>" /></div>
	                                                    </li>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-6.png')); ?>" /></div>
	                                                    </li>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-7.png')); ?>" /></div>
	                                                    </li>
	                                                    <li>
	                                                        <div class="latest-post"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/social-app/post-8.png')); ?>" /></div>
	                                                    </li>
	                                                </ul>
	                                            </div>
	                                        </div>
	                                    ...
	                                    <div class="card">
	                                        ...
	                                        <div class="collapse show" id="collapseicon13" data-parent="#accordion" aria-labelledby="collapseicon13">
	                                            <div class="card-body avatar-showcase filter-cards-view">
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/5.jpg')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/2.png')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/3.png')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/6.jpg')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/10.jpg')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/14.png')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/4.jpg')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/11.png')); ?>" alt="#" /></div>
	                                                <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle" src="<?php echo e(asset('assets/images/user/8.jpg')); ?>" alt="#" /></div>
	                                            </div>
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-xl-12 col-md-6 xl-50 box-col-6">
	                                    <div class="card"><img class="img-fluid" src="<?php echo e(asset('assets/images/social-app/timeline-4.png')); ?>" alt="" /></div>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
	                                            ...
	                                            <ul>
	                                                <li>
	                                                    <div class="add-friend text-center">
	                                                        <img class="img-60 img-fluid rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/2.png')); ?>" /><span class="d-block f-w-600">Jason Borne</span>
	                                                        <button class="btn btn-primary btn-xs">Add Friend</button>
	                                                    </div>
	                                                </li>
	                                                <li>
	                                                    <div class="add-friend text-center">
	                                                        <img class="img-60 img-fluid rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/3.png')); ?>" /><span class="d-block f-w-600">Anna Mull</span>
	                                                        <button class="btn btn-primary btn-xs">Add Friend</button>
	                                                    </div>
	                                                </li>
	                                                <li>
	                                                    <div class="add-friend text-center">
	                                                        <img class="img-60 img-fluid rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" /><span class="d-block f-w-600">Dion Cast</span>
	                                                        <button class="btn btn-primary btn-xs">Add Friend</button>
	                                                    </div>
	                                                </li>
	                                                <li>
	                                                    <div class="add-friend text-center">
	                                                        <img class="img-60 img-fluid rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/4.jpg')); ?>" /><span class="d-block f-w-600">Karlene Lex</span>
	                                                        <button class="btn btn-primary btn-xs">Add Friend</button>
	                                                    </div>
	                                                </li>
	                                                <li>
	                                                    <div class="add-friend text-center">
	                                                        <img class="img-60 img-fluid rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/8.jpg')); ?>" /><span class="d-block f-w-600">Vella Chism</span>
	                                                        <button class="btn btn-primary btn-xs">Add Friend</button>
	                                                    </div>
	                                                </li>
	                                                <li>
	                                                    <div class="add-friend text-center">
	                                                        <img class="img-60 img-fluid rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/10.jpg')); ?>" /><span class="d-block f-w-600">Wai Schalk</span>
	                                                        <button class="btn btn-primary btn-xs">Add Friend</button>
	                                                    </div>
	                                                </li>
	                                            </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Viho-Laravel-8/theme/resources/views/admin/apps/social-app.blade.php ENDPATH**/ ?>