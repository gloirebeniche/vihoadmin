<?php $__env->startSection('title'); ?>Email App
 <?php echo e($title); ?>
	                                ...
	                                <div class="inbox">
	                                    <div class="media">
	                                        <div class="media-size-email">
	                                            ...
	                                            <i class="like" data-feather="star"></i><img class="me-3 rounded-circle" src="<?php echo e(asset('assets/images/user/user.png')); ?>" alt="" />
	                                        </div>
	                                        <div class="media-body">
	                                            <h6>Pork Lorn</h6>
	                                    ...
	                                    <div class="media">
	                                        <div class="media-size-email">
	                                            ...
	                                            <i data-feather="star"></i><img class="me-3 rounded-circle" src="<?php echo e(asset('assets/images/user/user.png')); ?>" alt="" />
	                                        </div>
	                                        <div class="media-body">
	                                            <h6>Dee Deo</h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Viho-Laravel-8/theme/resources/views/admin/apps/email_inbox.blade.php ENDPATH**/ ?>