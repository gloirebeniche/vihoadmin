	                                    ...
	                                    <div class="row">
	                                        <div class="col text-center pe-0 call-content">
	                                            <div>
	                                                ...
	                                                <div class="receiver-img"><img src="<?php echo e(asset('assets/images/other-images/receiver-img.jpg')); ?>" alt="" /></div>
	                                            </div>
	                                        </div>
	                                        <div class="col-sm-6 caller-img-sec">
	                                            <div class="caller-img"><img class="img-fluid bg-img-cover" src="<?php echo e(asset('assets/images/other-images/caller.jpg')); ?>" alt="" /></div>
	                                        </div>
	                                    </div>
	                                </div>
	                                <!-- chat-history ends-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Viho-Laravel-8/theme/resources/views/admin/apps/chat-video.blade.php ENDPATH**/ ?>