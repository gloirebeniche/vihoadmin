	                    ...
	                    <div class="row my-gallery gallery" id="aniimated-thumbnials" itemscope="">
	                        <figure class="col-md-3 img-hover hover-1" itemprop="associatedMedia" itemscope="">
	                            <a href="<?php echo e(asset('assets/images/big-lightgallry/08.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                <div><img src="<?php echo e(asset('assets/images/lightgallry/08.jpg')); ?>" itemprop="thumbnail" alt="Image description" /></div>
	                            </a>
	                            <figcaption itemprop="caption description">Image caption 1</figcaption>
	                        </figure>
	                        <figure class="col-md-3 img-hover hover-1" itemprop="associatedMedia" itemscope="">
	                            <a href="<?php echo e(asset('assets/images/big-lightgallry/09.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                <div><img src="<?php echo e(asset('assets/images/lightgallry/09.jpg')); ?>" itemprop="thumbnail" alt="Image description" /></div>
	                            </a>
	                            <figcaption itemprop="caption description">Image caption 2</figcaption>
	                        </figure>
	                        <figure class="col-md-3 img-hover hover-1" itemprop="associatedMedia" itemscope="">
	                            <a href="<?php echo e(asset('assets/images/big-lightgallry/010.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                <div><img src="<?php echo e(asset('assets/images/lightgallry/010.jpg')); ?>" itemprop="thumbnail" alt="Image description" /></div>
	                            </a>
	                            <figcaption itemprop="caption description">Image caption 3</figcaption>
	                        </figure>
	                        <figure class="col-md-3 img-hover hover-1" itemprop="associatedMedia" itemscope="">
	                            <a href="<?php echo e(asset('assets/images/big-lightgallry/011.jpg')); ?>" itemprop="contentUrl" data-size="1600x950">
	                                <div><img src="<?php echo e(asset('assets/images/lightgallry/011.jpg')); ?>" itemprop="thumbnail" alt="Image description" /></div>
	                            </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Viho-Laravel-8/theme/resources/views/admin/gallery/gallery-hover.blade.php ENDPATH**/ ?>