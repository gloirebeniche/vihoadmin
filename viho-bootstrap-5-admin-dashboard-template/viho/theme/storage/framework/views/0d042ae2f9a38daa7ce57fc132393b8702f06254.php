<?php $__env->startSection('title'); ?>Detailed Course
 <?php echo e($title); ?>
	        ...
	        <div class="col-xl-9 xl-60 box-col-8">
	            <div class="blog-single">
	                <div class="blog-box blog-details">
	                    <div class="card"><img class="img-fluid w-100" src="<?php echo e(asset('assets/images/faq/learning-1.jpg')); ?>" alt="blog-main" /></div>
	                    <div class="card">
	                        <div class="card-body">
	                        ...
	                        <ul>
	                            <li>
	                                <div class="media align-self-center">
	                                    <img class="align-self-center" src="<?php echo e(asset('assets/images/blog/comment.jpg')); ?>" alt="Generic placeholder image" />
	                            ...
	                            <li>
	                                <ul>
	                                    <li>
	                                        <div class="media">
	                                            <img class="align-self-center" src="<?php echo e(asset('assets/images/blog/9.jpg')); ?>" alt="Generic placeholder image" />
	                                            <div class="media-body">
	                                                <div class="row">
	                                                    <div class="col-xl-12">
	                                                        <a href="user-profile.html">
	                            ...
	                            <li>
	                                <div class="media">
	                                    <img class="align-self-center" src="<?php echo e(asset('assets/images/blog/4.jpg')); ?>" alt="Generic placeholder image" />
	                                    <div class="media-body">
	                                        <div class="row">
	                                            <div class="col-md-4 xl-100">
	                                                <a href="user-profile.html">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Viho-Laravel-8/theme/resources/views/admin/miscellaneous/learning-detailed.blade.php ENDPATH**/ ?>