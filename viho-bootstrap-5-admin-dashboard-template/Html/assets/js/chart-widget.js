    ...
    var chartlinechart50 = new ApexCharts(document.querySelector("#chart-widget50"), optionslinechart50);
    chartlinechart50.render();

      /*Line chart51*/
      var optionslinechart51 = {
        chart: {
            toolbar: {
                show: false
            },
    ...
    var chartlinechart51 = new ApexCharts(document.querySelector("#chart-widget51"), optionslinechart51);
    chartlinechart51.render();

    
      /*Line chart52*/
      var optionslinechart52 = {
        chart: {
            toolbar: {
                show: false
            },
